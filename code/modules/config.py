...
logging.getLogger("transformers").setLevel(logging.ERROR)  # Mute warnings
...
T5_QA_GPT_HF_REFERENCE = 'psxjp5/mt5-small'
BART_QA_GPT_HF_REFERENCE = 'psxjp5/bart-large-xsum'
...
set_seed(SEED)
RPM = 3500  # The RPM limit for querying GPT
